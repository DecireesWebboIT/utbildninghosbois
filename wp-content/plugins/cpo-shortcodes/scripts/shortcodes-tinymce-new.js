						...
						
						{
							...
							onclick: function() {
								editor.windowManager.open( {
									...
									onsubmit: function(e){
										editor.selection.insertContent('[button url="' + e.data.buttonUrl + '" color="' + e.data.buttonColor + '" size="' + e.data.buttonSize + '" border_radius="' + e.data.buttonBorderRadius + '" target="' + e.data.buttonLinkTarget + '" rel="' + e.data.buttonRel + '" icon_left="' + e.data.buttonLeftIcon + '" icon_right="' + e.data.buttonRightIcon + '"]' + e.data.buttonText + '[/symple_button]');
									}
								});
							}
						},
