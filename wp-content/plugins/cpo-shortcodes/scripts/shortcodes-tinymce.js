							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									onsubmit: function(e){
										...
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'dropcap color="' + e.data.color +  '" style="' + e.data.style + '" ' + element_id + element_class + element_animation + ']' + e.data.text +  '[/' + ctsc_vars.prefix + 'dropcap]');
									}
								});
							}
						},
						...
						},
						{
							...
							onclick: function(){ 
								editor.windowManager.open({
									...
									body: ctsc_generator_definition,
									onsubmit: function(e){
										var element_id = e.data.id !== '' ? ' id="' + e.data.id + '"' : '';
										var element_class = e.data.class !== '' ? ' class="' + e.data.class + '"' : '';
										var element_animation = e.data.animation !== '' ? ' animation="' + e.data.animation + '"' : '';
										editor.selection.setContent('[' + ctsc_vars.prefix + 'definition title="' + e.data.title + '" ' + element_id + element_class + element_animation + '][/' + ctsc_vars.prefix + 'definition]');
									}
								});
							}
						},
