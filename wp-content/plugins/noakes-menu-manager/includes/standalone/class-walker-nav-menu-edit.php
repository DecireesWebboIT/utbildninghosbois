 ...
 * 
 * @since 1.3.0 Removed the buttons action hook.
 * @since 1.2.5 Deprecated buttons action hook for added compatibility.
 * @since 1.2.4 Updated menu item buttons for WordPress 4.7.
 * @since 1.1.0 Added nav menu item buttons action hook.
 * @since 1.0.4 Added minor change for WordPress 4.6.
 * @since 1.0.1 Changed action hook for compatibility.
 * @since 1.0.0
 * 
...
if (!class_exists('Noakes_Walker_Nav_Menu_Edit'))
{
	class Noakes_Walker_Nav_Menu_Edit extends Walker_Nav_Menu
	{
		/**
			...
			<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
				...
				<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
					...
					<?php
						 ...
						 * 
						 * @since 1.0.1 Changed the action hook name.
						 * @since 1.0.0
						 * 
					...
					<?php if (Noakes_Menu_Manager()->_cache->four_seven) : ?>
